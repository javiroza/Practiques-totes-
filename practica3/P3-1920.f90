...
double precision a,eps,Eo,dfu,vect1,fu
double precision t,pi
integer niter,i
external F,G

common/dades/t,a,eps,pi
a=17.857619
eps=0.967990
pi=dacos(-1.d0)
...
subroutine coord(x,y,E)
    ...
    double precision t,a,eps,pi
    common/dades/t,a,eps,pi

    x=a*(cos(E)-eps)
    y=a*sin(E)*(1-eps**2)**0.5d0
...
subroutine Bisection(A,B,eps,function,niter,xarrel) ! Output --> xarrel
    ...
    do i=1,maxiter-1    
        call function(A,fa,dfu)
        call function(B,fb,dfu)
...
subroutine F(E,fu)
    implicit none
    double precision E,fu
    double precision t,a,eps,pi
    common/dades/t,a,eps,pi

    fu = sin(2*E)*(1-eps**2)-sin(E)*(cos(E)*(2.d0-eps**2)-eps)
...
subroutine G(E,fu,dfu)
    implicit none
    double precision E,fu,Th,dfu
    double precision t,a,eps,pi
    common/dades/t,a,eps,pi

    Th=73.5d0
    fu = E-t*(2*pi)/Th+sin(E)*eps
    dfu = 1+eps*cos(E)
